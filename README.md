...
2. Abre una terminal (PowerShell o CMD) **como administrador**.
3. Navega al directorio raíz del proyecto.
4. Ejecuta el script:
   ```
   python src/driver_analyzer.py
   ```
5. El análisis comenzará y los resultados se mostrarán en la consola. Al finalizar, encontrarás un archivo `report.txt` en el mismo directorio.
